 ...
 */
package com.thinkgem.jeesite_mybatis.modules.act.service.ext;

import java.util.List;
import java.util.Map;

import com.thinkgem.jeesite_mybatis.modules.act.utils.ActUtils;
import com.thinkgem.jeesite_mybatis.modules.sys.service.SystemService;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.thinkgem.jeesite_mybatis.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.thinkgem.jeesite_mybatis.modules.sys.entity.User(null, userId)))){
